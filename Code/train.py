...
def parse():
    ...
    parser.add_argument('-lm', '--load-model', type=bool, default=False, help='Loading model')
    parser.add_argument('-lr', '--lr', type=float, default=1e-3, help='Learning rate')
    parser.add_argument('-lt', '--lt', type=str, default='plain', help='Learning type')
    ...
    parser.add_argument('-k', '--nker', type=int, default=384, help='Size of image')
    parser.add_argument('-nb', '--nblk', type=int, default=16, help='Number of Block')
